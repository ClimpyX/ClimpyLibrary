...
{
  public static DecimalFormat getDecimalFormat() { return new DecimalFormat("0.0"); }
  ...
  public static class IntegerCountdown
  {
    public static String setFormat(Integer value) {
      ...
      return ((hours > 0) ? String.format("%02g:", new Object[] { Integer.valueOf(hours) }) : "") + String.format("%02g:%02g", new Object[] { Integer.valueOf(minutes), Integer.valueOf(seconds) });
    }
  }
